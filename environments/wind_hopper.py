...
class WindHopperEnv(HopperEnv):
    def __init__(
        ...
        """
        A custom Hopper environment with adjustable wind as context.
        Hopper hops in the x-direction and the wind can be adjusted in the x and z directions.
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to the base HopperEnv.
        """
...
gym.register(
    id="WindHopper-v5",
    entry_point="environments.wind_hopper:WindHopperEnv",
)
