...
class WindWalker2dEnv(Walker2dEnv):
    def __init__(
            self,
        ...
        """
        A custom Walker2d environment with adjustable wind as context.
        Walker2d walks in the x-direction and the wind can be adjusted in the x and z directions.
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments passed to the base Walker2dEnv.
        """
...
gym.register(
    id="WindWalker2d-v5",
    entry_point="environments.wind_walker2d:WindWalker2dEnv",
)
